...
f <- list()
f[["total.area"]]  <- total.area ~ map_mean*mat_mean*map_var_mean*mat_var_mean
f[["range.size"]] <- range.size ~ map_mean*mat_mean*map_var_mean*mat_var_mean
f[["effective.mesh.size"]] <-  effective.mesh.size ~ map_mean*mat_mean*map_var_mean*mat_var_mean
f[["prop.landscape"]] <- prop.landscape ~ map_mean*mat_mean*map_var_mean*mat_var_mean
f[["mean.shape.index"]] <- mean.shape.index ~ map_mean*mat_mean*map_var_mean*mat_var_mean
f[["perimeter.area.frac.dim"]] <- perimeter.area.frac.dim ~ map_mean*mat_mean*map_var_mean*mat_var_mean
...
print("saving models")
saveRDS(m_metric, "m_metric_clim.rds")

print("prep null model")
...
print("saving null models")
saveRDS(m_metric, "m_metric_null.rds")
