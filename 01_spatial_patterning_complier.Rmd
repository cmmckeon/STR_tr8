...
```{r}
mydata <- unique(merge(mydata, traits_bien, traits, by.x = "Species", by.y = "scrubbed_species_binomial", by.z = "Speices.x", all.x = TRUE)) ## gonna leave in all the vars for now...
```
