...
get some example species
```{r}

# dia <- raster("occ_rasters/occDianthus_arenarius.tif")
# ros <- raster("occ_rasters/occRosa_sherardii.tif") ## high occupied area, average mat_var
# del <- raster("occ_rasters/occDelphinium_elatum.tif")
