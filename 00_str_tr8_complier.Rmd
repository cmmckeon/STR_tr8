...
length(unique(metrics$species))
# length(unique(metrics$species[grep(" ssp.*", metrics$species)]))
# f <- as.data.frame(droplevels(metrics$species[grep(" ssp.*", metrics$species)]))
```
