...
#ßmetrics <- metrics[metrics$perimeter.area.frac.dim != "Inf",]
metrics <- metrics[metrics$species != "Helleborus lividus",]

## log transform raw data
metrics$perimeter.area.frac.dim <- (metrics$perimeter.area.frac.dim + sqrt(min(metrics$perimeter.area.frac.dim)^2)) + 1
