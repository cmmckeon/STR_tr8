...
# resp <-ggarrange(p[[1]],p[[2]],p[[3]],p[[4]],p[[5]],#p[[6]], 
#                  labels = c("A", "B", "C", "D", "E"), 
...
```{r}
tab <- function(sum.df, caption = "Table C.1.1. Model outputs for communities at the level of haul") { 
...
r2 <- r2[r2$r !=  "Geographic range fractality",]

r2$r <- factor(r2$r, levels = c("Occupied area", "Geographic range size", "Patch size distribution", "Geographic range filling", "Patch shape complexity"))
